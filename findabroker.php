                        ...
                        <div class="container vertical-align">
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <h1 class="text-white">Find a mortgage broker</h1>
                                    <p>Select a city from our dropdown menu to get started!</p>
                                    <?php
                                        // Connect to the database
                                        $db = new mysqli('localhost', 'root', 'W1ll1@m!!', 'Waterfront');
                                        if ($db->connect_errno) {
                                            echo "Failed
                                            // Retrieve the list of cities from the database
                                            $result = $db->query("SELECT city FROM cities");
